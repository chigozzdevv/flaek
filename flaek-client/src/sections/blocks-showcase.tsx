      ...
      <div className="container-outer py-16 md:py-24">
        ...
        >
          ...
          <p className="mt-3 text-base md:text-lg text-white/60 max-w-xl mx-auto">
            Pre-built Arcium MXE circuits for private compute
          </p>
        </motion.div>

        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-7 gap-3 md:gap-4 max-w-5xl mx-auto">
          {BLOCKS.map((block, i) => (
            <motion.div
              key={block.id}
