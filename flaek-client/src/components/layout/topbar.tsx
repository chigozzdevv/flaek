...
export function Topbar() {
  ...
  async function loadCredits() {
    try {
      ...
      const balance = tenant.balance_cents ?? 0
      setCredits(balance / 100)
    } catch (error) {
  ...
  return (
    <div className="h-16 border-b border-white/10 bg-bg-base flex items-center justify-between px-6">
